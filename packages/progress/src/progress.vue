<template>
  <div
    ...
    aria-valuemax="100"
  >
    <div class="tj-progress-bar" v-if="type === 'line'">
      <div class="tj-progress-bar__outer" :style="{height: strokeWidth + 'px'}">
        <div class="tj-progress-bar__inner" :style="barStyle">
          <div class="tj-progress-bar__innerText" v-if="showText && textInside">{{content}}</div>
        </div>
      </div>
    </div>
    <div class="tj-progress-circle" :style="{height: width + 'px', width: width + 'px'}" v-else>
