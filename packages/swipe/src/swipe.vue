<template>
  <div class="tj-swipe" :style="`height:${height}`">
    <div class="tj-swipe-items-wrap" ref="wrap">
      <slot></slot>
    </div>
    <div class="tj-swipe__indicators" v-show="showIndicators">
      <div
        class="tj-swipe__indicator"
